...
String url = "https://cas.800jit.com/ssocenter/login?locale=en&serverName="+serverName+"&cookieUserName="+cookieUserName+"&serverPort="+serverPort+(queryString != null ? "&" + queryString : "")+"&rd="+System.currentTimeMillis();
