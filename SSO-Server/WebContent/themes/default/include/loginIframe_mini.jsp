...
String url = "https://cas.800jit.com/ssocenter/login?locale=zh_CN&serverName="+serverName+"&cookieUserName="+cookieUserName+"&serverPort="+serverPort+"&identity=huozhu"+(queryString != null ? "&" + queryString : "")+"&rd="+System.currentTimeMillis();
