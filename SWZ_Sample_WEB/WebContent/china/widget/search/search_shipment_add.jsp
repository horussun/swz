  ...
  <div class="constraints">
          ...
          <%@ include file="search_add_date_part.jsp" %>
           <!--   <tr>
            ...
            <tr>
		<th><fmt:message key="BEAN_CE_BILLLW_P_carrier"	bundle="${ClientStrings}"></fmt:message></th>
		...
		<td><input name="scac_shipment"  maxHeight="150" id="s_scac" dojotype="dijit.form.Select" />
	    </td>
		</tr>
            <tr>
            ...
            <tr>
              ...
              <td><select dojotype="dijit.form.FilteringSelect" autoComplete="true" name="equipment">
              		<option value><fmt:message key="SEARCH_STR_all" bundle="${ClientStrings}"/></option>
              		<c:forEach var="temp" items="${equipment}" varStatus="s">
						<option value="${temp.key}:${temp}">${temp.displayObject}</option>
					</c:forEach>
              	  </select>
              </td>
            ...
            <tr>
              ...
              <td colspan="3" class="radio_td"> 
               ...
               <input  type="radio"  dojoType="dijit.form.RadioButton" name="hasNote"  checked="2" value="2"/><label for="radioOne"> <fmt:message key="SEARCH_STR_either" bundle="${ClientStrings}"/> </label></td>
            </tr>
            <tr>
              ...
              <td colspan="3"  class="radio_td"> 
               ...
               <input  type="radio" dojoType="dijit.form.RadioButton"  name="alert"  checked="true" value="2"/><label for="radioOne"> <fmt:message key="SEARCH_STR_either" bundle="${ClientStrings}"/> </label></td>
            </tr>
            <tr>
            ...
            <td><input type="text"  dojoType="dijit.form.TextBox"  name="loadPlanId"/></td>
            </tr>
             <tr>
              <th><fmt:message key="BEAN_LM_LMITEM_P_loadPlanStatus" bundle="${ClientStrings}"/></th>
              <td>
              	<select dojotype="dijit.form.FilteringSelect" autoComplete="true" name="loadPlanStatus" >
              		<option value><fmt:message key="SEARCH_STR_all" bundle="${ClientStrings}"/></option>
            ...
            <tr>
              ...
              <td>
              	<select dojotype="dijit.form.FilteringSelect" autoComplete="true" name="invoiceStatus" >
              		<option value><fmt:message key="SEARCH_STR_all" bundle="${ClientStrings}"/></option>
     ...
     <div id="btarea">
       ...
       <span class="activebt"> 
        <button dojotype="dijit.form.Button"><fmt:message key="CMD_disp_save" bundle="${ClientStrings}"/>
