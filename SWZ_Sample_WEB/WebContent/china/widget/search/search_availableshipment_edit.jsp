...
<style type="text/css">
  ...
  <div id="content2">
 	 ...
 	 <div class="constraints">
          ...
          <!--   <tr>
            ...
            <th><fmt:message key="BEAN_CE_PROMPTEDTENDERLW_P_trailerContainerNo" bundle="${ClientStrings}"/></th>
              <td><input type="text"  dojoType="dijit.form.TextBox"  name="trailerNbr" value="${currentSearchValues.trailerNbr_startsWith}"/></td>
            </tr>
           <tr>
		...
		<th><fmt:message key="BEAN_CE_BILLLW_P_scacCode"
			bundle="${ClientStrings}"></fmt:message></th>
		<td>
			<select name="scac"  maxHeight="150" id="s_scac" dojotype="dijit.form.Select"  <c:if test="${currentSearchValues.scac_eq!=null}">value="${currentSearchValues.scac_eq}" </c:if> >
            ...
            <tr>
              ...
              <td colspan="3" > <textarea class="info_textarea" dojoType="dijit.form.Textarea" name="itemDescription_availableShipment" value="${currentSearchValues.itemDescription_eq}"></textarea></td>
            </tr>
           ...
           <tr>
            ...
            <tr>
            <th>SKU</th>
              <td><input type="text"  dojoType="dijit.form.TextBox"  name="sku" value="${currentSearchValues.sku_eq}"/></td>
            </tr>
          <tr>
     ...
     <div id="btarea">
       ...
       <span class="activebt"> <button dojotype="dijit.form.Button" onClick = "Common.currentpage.deleteSearch('availableshipment')"><fmt:message key="CMD_delete_routeGuide" bundle="${ClientStrings}"/></button></span>
