...
dojo.declare("dojox.data.QueryReadStore",
	null,
	{
		...
		_xhrFetchHandler: function(data, request, fetchHandler, errorHandler){
			//modified by lfp 2011-12-27
			//data = this._filterResponse(data); original
			data = this._filterResponse(data,request);
			//modified by lfp 2011-12-27 end 
		...
		_fetchItems: function(request, fetchHandler, errorHandler){
			...
			//modify by lfp  2011-12-21
			var serverQuery = request.serverQuery || dojo.clone(request.query) || {};
