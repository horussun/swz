...
import com.olymtech.cas.client.util.SecureURL;

/**
 * Validates STs and optionally retrieves PGT IOUs. Designed with a bean-like
 * interface for simplicity and generality.
 */
public class ServiceTicketValidator {
	...
	com.olymtech.cas.client.ServiceTicketValidator sv = new com.olymtech.cas.client.ServiceTicketValidator();
    ...
    private String casValidateUrl, proxyCallbackUrl, st, service, pgtIou, user, errorCode, errorMessage, entireResponse,tgt;
    private boolean renew = false;
    private boolean attemptedAuthentication;
    private boolean successfulAuthentication;
    private String webServerIPandPort;
    ...
    public String getWebServerIPandPort() {
	return webServerIPandPort;
    }

    public void setWebServerIPandPort(String webServerIPandPort) {
	this.webServerIPandPort = webServerIPandPort;
    }
    ...
    /**
     * Gets the CAS validation URL to use when validating tickets and retrieving
     * PGT IOUs.
     */
	...
	if (webServerIPandPort != null)
	    sb.append("&webServerIPandPort=" + webServerIPandPort);
	...
	protected static final String TICKET_GRANTING_TICKET = "cas:ticketGrantingTicket";
	...
	protected String netid, pgtIou, errorCode, errorMessage,tgt;
	...
	public void endElement(String ns, String ln, String qn) throws SAXException {
		...
		if (qn.equals(TICKET_GRANTING_TICKET))
		    tgt = currentText.toString().trim();
	...
	public void endDocument() throws SAXException {
		...
		ServiceTicketValidator.this.tgt = tgt;
	...
	user = pgtIou = errorMessage = tgt = null;
