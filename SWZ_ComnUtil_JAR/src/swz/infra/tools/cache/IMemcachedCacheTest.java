...
import swz.infra.tools.cache.memcached.MemcacheStats;
import swz.infra.tools.cache.memcached.MemcacheStatsSlab;
import swz.infra.tools.cache.memcached.MemcachedCacheManager;
import swz.infra.tools.cache.memcached.MemcachedResponse;
import swz.infra.tools.cache.memcached.MemcacheStatsSlab.Slab;
...
public class IMemcachedCacheTest
{
	...
	/**
	 * Test method for {@link com.olymtech.common.cache.ICache#get(java.lang.Object)}.
	 */
	@Test
	public void testGet()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testGet", "", ex);
	...
	/**
	 * Test method for {@link com.olymtech.common.cache.ICache#remove(java.lang.Object)}.
	 */
	@Test
	public void testRemove()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testRemove", "", ex);
			Assert.assertTrue(false);
		}
	}	
	...
	public void testKeysetValues()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testKeysetValues", "", ex);
			Assert.assertTrue(false);
		}
	}
	...
	public void testcontainsKey()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testcontainsKey", "", ex);
			Assert.assertTrue(false);
		}
	}
	
	/**
	 * Test method for {@link com.olymtech.common.cache.IMemcachedCache#get(java.lang.String, int)}.
	 */
	@Test
	public void testGetStringInt()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testGetStringInt", "", ex);
			Assert.assertTrue(false);
		}
	...
	public void testgetMulti()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testgetMulti", "", ex);
			Assert.assertTrue(false);
		}
	...
	/**
	 * Test method for {@link com.olymtech.common.cache.IMemcachedCache#incr(java.lang.String, long)}.
	 */
	@Test
	public void testIncr()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testIncr", "", ex);
			Assert.assertTrue(false);
		}
	}
	
	/**
	 * Test method for {@link com.olymtech.common.cache.IMemcachedCache#decr(java.lang.String, long)}.
	 */
	@Test
	public void testDecr()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testDecr", "", ex);
			Assert.assertTrue(false);
		}
	}
	
	/**
	 * Test method for {@link com.olymtech.common.cache.IMemcachedCache#addOrIncr(java.lang.String, long)}.
	 */
	@Test
	public void testAddOrIncr()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testAddOrIncr", "", ex);
			Assert.assertTrue(false);
		}
	}

	/**
	 * Test method for {@link com.olymtech.common.cache.IMemcachedCache#addOrDecr(java.lang.String, long)}.
	 */
	@Test
	public void testAddOrDecr()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testAddOrDecr", "", ex);
			Assert.assertTrue(false);
		}
	}
	
	/**
	 * Test method for {@link com.olymtech.common.cache.IMemcachedCache#statsSlabs()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link com.olymtech.common.cache.IMemcachedCache#stats()}.
	 */
	@Test
	...
	public void testStatCacheResponse()
	{
		...
		{
			e.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testStatCacheResponse", "InterruptedException", e);
			Assert.assertTrue(false);
		}
	...
	public void testAdd()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testAdd", "", ex);
			Assert.assertTrue(false);
		}
	}
	...
	public void testReplace()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testReplace", "", ex);
			Assert.assertTrue(false);
		}
	}	
	
	/**
	 * Test method for {@link com.olymtech.common.cache.ICache#clear()}.
	 */
	@Test
	public void testClear()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testClear", "", ex);
			Assert.assertTrue(false);
		}
	}		
	...
	public void testAnsyPut()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testAnsyPut", "", ex);
			Assert.assertTrue(false);
		}
	}
	...
	public void testAnsyStoreCounter()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testAnsyStoreCounter", "", ex);
			Assert.assertTrue(false);
		}
	}
	...
	public void testAnsyAddOrIncr()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testAnsyAddOrIncr", "", ex);
			Assert.assertTrue(false);
		}
	}
	...
	public void testAnsyAddOrDecr()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testAnsyAddOrDecr", "", ex);
			Assert.assertTrue(false);
		}
	}
	...
	public void testAnsyIncr()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testAnsyIncr", "", ex);
			Assert.assertTrue(false);
		}
	}
	...
	public void testAnsyDecr()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testAnsyDecr", "", ex);
			Assert.assertTrue(false);
		}
	}
	
	/**
	 * Test method for {@link com.olymtech.common.cache.ICache#put(java.lang.Object, java.lang.Object, java.util.Date)}.
	 */
	@Test
	public void testPutKVDate()
	{
		...
		{
			ex.printStackTrace();
			//AuditorFactory.getInstance().getVrwsAuditor().iWarn(this, "testPutKVDate", "", ex);
			Assert.assertTrue(false);
		}
	}	
